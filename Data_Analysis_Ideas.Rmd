...
As the conclusions/interpretation group can point out, the most represented indexes come from the libraries with the the largest read counts from among the pooled set. 
